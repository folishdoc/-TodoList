...
async function setupApiMocks(page: Page) {
  let items: any[] = [
    { id: 1, name: '生日', date: '2025-08-15', repeatType: 'YEARLY', remindEnabled: true, remindTime: '09:00', tags: '家人', notes: '', daysUntil: 5, nextDate: '2026-08-15' },
    { id: 2, name: '结婚纪念日', date: '2020-06-01', repeatType: 'YEARLY', remindEnabled: true, remindTime: '09:00', tags: '家人', notes: '', daysUntil: 20, nextDate: '2026-06-01' }
  ]
  let nextId = 100
